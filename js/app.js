//Instanciar variables funcionales
...
//carga de eventos y funcionalidad de eventos
...
//fuction para insertar catalogos en listacatalogos
...
//fucton para eliminar catalogos
...
//fuction para obtener los cataloslocales
...
//estoy filtrando todos los productos q sean distinto al id que recibe por parametro
function eliminarCatalogoLocalStorage(catalogo) {
     let catalogosLS;

     catalogosLS = obtenerCatalogosLocalStorage();

     catalogosLS = catalogosLS.filter( element => parseInt(element.id) !== parseInt(catalogo));

     localStorage.setItem('catalogos', JSON.stringify(catalogosLS));

}
//funcion para para hacer un clear en  localsotrage
